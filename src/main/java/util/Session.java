...
public class Session {
    ...
    public static Map<String, String> loginSession = new HashMap<>();
    public static String newLoginSession(User user){
        String sessionId = new Random().ints(leftLimit,rightLimit+1)
                ...
                .toString();
        loginSession.put(sessionId, user.getUserId());
        return sessionId;
    }

    public static Optional<String> findUserIdBySessionId(String sessionId){
